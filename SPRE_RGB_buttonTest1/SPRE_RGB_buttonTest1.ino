...
void loop() {
  ...
  colorWipe(strip.Color(255, 128, 0), 10);
  colorWipe(strip.Color(255, 255, 0), 10);
  colorWipe(strip.Color(255, 128, 0), 10);
  colorWipe(strip.Color(255, 0, 0), 20); // Red
  colorWipe(strip.Color(0, 0, 0), 20);
  colorWipe(strip.Color(0, 0, 0), 50);
  colorWipe(strip.Color(32, 32, 255), 2);
  ...
  */
  ...
  //colorWipe(strip.Color(0, 255, 255), 100); // Cyan
  //colorWipe(strip.Color(255, 0, 255), 100); // Magenta

  //colorWipe(strip.Color(0, 0, 0), 50); // black
  //colorWipe(strip.Color(255, 255, 255), 150); // white
  //colorWipe(strip.Color(0, 0, 0), 50); // black
  // END DEMO FOR ACRYLITE
